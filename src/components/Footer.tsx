  ...
  <div className="container-padded py-12">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center mb-3">
            <img src="/images/logofoooter.png" alt="Atisbe Academy Logo" className="h-48 w-auto" />
          </div>
        </div>
      ...
      {/* Copyright */}
      <div className="border-t border-white/20 py-4 text-center text-sm" style={{ color: '#791eba', opacity: 0.9 }}>
