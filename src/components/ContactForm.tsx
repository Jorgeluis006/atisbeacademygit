    ...
    <section className="py-12">
      <div className="container-padded w-full">
        <div className="max-w-3xl mx-auto">
          {title && <h2 className="text-4xl font-extrabold text-center mb-8">{title}</h2>}
          <form onSubmit={onSubmit} className="grid gap-4 bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <select className="border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-purple focus:border-transparent" name="idioma" required value={form.idioma} onChange={onChange}>
              ...
              <select className="border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-purple focus:border-transparent" name="dia_interes" required value={form.dia_interes} onChange={onChange}>
            ...
            <div className="flex gap-4 mt-4">
              ...
              <button 
                ...
                className="flex-1 bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
              >
